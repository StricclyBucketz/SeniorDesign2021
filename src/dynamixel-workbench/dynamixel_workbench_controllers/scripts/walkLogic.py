...
from functions import speed_pos_control

TOLERANCE = 10 # %tolerance = TOLERANCE / 1023 (In this case ~0.3%)
BASE_MOTOR_SPEED = 32 # Sets the speed for the servo moving the farthest in a state change.
...
def stepOff():
  ...
  speed_pos_control(3, math.ceil(0.874*BASE_MOTOR_SPEED), RIGHT_FOOT_FORWARD[2])
  speed_pos_control(4, BASE_MOTOR_SPEED, RIGHT_FOOT_FORWARD[3])
  ...
  speed_pos_control(8, BASE_MOTOR_SPEED, RIGHT_FOOT_DOWN[7])
  speed_pos_control(9, math.ceil(0.533*BASE_MOTOR_SPEED), RIGHT_FOOT_DOWN[8])
  speed_pos_control(10, math.ceil(0.495*BASE_MOTOR_SPEED), RIGHT_FOOT_DOWN[9])
...
def leftStep():
  ...
  speed_pos_control(3, math.ceil(0.874*BASE_MOTOR_SPEED), RIGHT_LEG_STRAIGHT[2])
  speed_pos_control(4, BASE_MOTOR_SPEED, RIGHT_LEG_STRAIGHT[3])
  ...
  speed_pos_control(9, math.ceil(0.382*BASE_MOTOR_SPEED), LEFT_FOOT_FORWARD[8])
  speed_pos_control(10, math.ceil(0.539*BASE_MOTOR_SPEED), LEFT_FOOT_FORWARD[9])
  speed_pos_control(11, BASE_MOTOR_SPEED, LEFT_FOOT_FORWARD[10])
  ...
  speed_pos_control(2, BASE_MOTOR_SPEED, LEFT_FOOT_DOWN[1])
  speed_pos_control(3, math.ceil(0.537*BASE_MOTOR_SPEED), LEFT_FOOT_DOWN[2])
  speed_pos_control(4, math.ceil(0.491*BASE_MOTOR_SPEED), LEFT_FOOT_DOWN[3])
...
#  rospy.loginfo("LEFT_LEG_STRAIGHT")
  ...
  speed_pos_control(9, math.ceil(0.959*BASE_MOTOR_SPEED), LEFT_LEG_STRAIGHT[8])
  speed_pos_control(10, BASE_MOTOR_SPEED, LEFT_LEG_STRAIGHT[9])
...
#  rospy.loginfo("RIGHT_FOOT_FORWARD")
  ...
  # speeds = calculateServoSpeed()
  # speed_pos_control(1, speeds[0], RIGHT_FOOT_FORWARD[0])
  speed_pos_control(2, math.ceil(0.365*BASE_MOTOR_SPEED), RIGHT_FOOT_FORWARD[1])
  speed_pos_control(3, math.ceil(0.507*BASE_MOTOR_SPEED), RIGHT_FOOT_FORWARD[2])
  speed_pos_control(4, BASE_MOTOR_SPEED, RIGHT_FOOT_FORWARD[3])
  # speed_pos_control(5, speeds[4], RIGHT_FOOT_FORWARD[4])
  # speed_pos_control(6, speeds[5], RIGHT_FOOT_FORWARD[5])
  # speed_pos_control(7, speeds[6], RIGHT_FOOT_FORWARD[6])
...
#  rospy.loginfo("STAND")
  ...
  speed_pos_control(2, BASE_MOTOR_SPEED, STAND[1])
  speed_pos_control(3, math.ceil(0.537*BASE_MOTOR_SPEED), STAND[2])
  speed_pos_control(4, math.ceil(0.491*BASE_MOTOR_SPEED), STAND[3])
...
#  rospy.loginfo("STAND")
  ...
  # speed_pos_control(6, speeds[5], STAND[5])
  # speed_pos_control(7, speeds[6], STAND[6])
  speed_pos_control(8, BASE_MOTOR_SPEED, STAND[7])
  speed_pos_control(9, math.ceil(0.533*BASE_MOTOR_SPEED), STAND[8])
  speed_pos_control(10, math.ceil(0.495*BASE_MOTOR_SPEED), STAND[9])
  # speed_pos_control(11, speeds[10], STAND[10])
  # speed_pos_control(12, speeds[11], STAND[11])
  spinWhileMoving()
