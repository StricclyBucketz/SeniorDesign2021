...
if __name__ == "__main__":
  ...
  position_control(2, R_NEUTRAL[1])
  position_control(3, R_NEUTRAL[2])
  position_control(4, R_NEUTRAL[3])
  position_control(5, FIVETWELVE[4])
  position_control(6, FIVETWELVE[5])
  position_control(7, FIVETWELVE[6])
  position_control(8, L_NEUTRAL[7])
  position_control(9, L_NEUTRAL[8])
  position_control(10, L_NEUTRAL[9])
  position_control(11, FIVETWELVE[10])
  position_control(12, FIVETWELVE[11])
  time.sleep(DELAY)
